                            ...
                            <div class="card card-full">
                                ...
                                <div class="nk-tb-list mt-n2">
                                    <div class="nk-tb-item nk-tb-head">
                                        ...
                                        <div class="nk-tb-col tb-col-sm"><span>Previous Balance</span></div>
                                        <div class="nk-tb-col tb-col-sm"><span>Available Balance</span></div>
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-sm">
                                            <div class="user-card">
                                                <div class="user-name">
                                                    <span class="tb-lead">{{moneyFormat($invest->avail_balance, 'USD')}}</span>
                                                </div>
                                            </div>
                                        </div>
