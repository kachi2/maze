                                ...
                                <form method="post" action="{{ route('deposits.invests', ['id' => encrypt($plan->id)]) }}">
                                 ...
                                 <div class="pricing-head"><div class="pricing-title">
                                     ...
                                     <div class="card-text"><div class="row"><div class="col-6">
                                         ...
                                         <div class="col-6"><span class="h4 fw-500">{{ $plan->package->duration }}</span><span class="sub-text"></span></div></div></div>
                                         </div>
                                                         ...
                                                         <form  action="{{route('web.saveHashNo')}}" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <input name="hashNo" type="text" class="form-control "  @if(Session::has('done')) placeholder="Hash reference submitted" {{Session::get('done')}} @else placeholder="Enter your reference id / hash" @endif required>
                                                                </div>
                                                            </div>
