                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="full">
                        <div class="inner_page_info">
                            <h3>Join the Binance Affiliate Program</h3>
                            <ul>
                                <li><a href="#">Monetize your traffic and earn crypto commissions when you share Binance with your audiences. Content creators, influencers and platforms can earn commissions and special rewards on every trade, across Binance Spot, Futures, Margin trading or even Binance Pool.</a></li>
                                <li><i class="fa fa-angle-right"></i></li>
                                <li><a href="#"><button class="btn btn-primary"> Become an Affiliate</button></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
