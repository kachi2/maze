                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        <li><a href="{{ route('web.withdrawals.request') }}" class="btn btn-white btn-dim btn-outline-light"><em class="icon ni ni-arrow-up"></em><span>Request Withdrawal</span></a></li>
